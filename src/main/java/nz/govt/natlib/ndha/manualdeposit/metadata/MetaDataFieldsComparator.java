...
public class MetaDataFieldsComparator implements
		Comparator<IMetaDataTypeExtended>, Serializable {

	private static final long serialVersionUID = 2641806474967709936L;

	public int compare(IMetaDataTypeExtended metaFrom,
			IMetaDataTypeExtended metaTo) {
