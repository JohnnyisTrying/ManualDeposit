...
public class InvalidApplicationDataException extends Exception {
	...
	public InvalidApplicationDataException(final String message) {
		super(message);
	}

	public InvalidApplicationDataException(final Throwable cause) {
		super(cause);
	}

	public InvalidApplicationDataException(final String message, final Throwable cause) {
		super(message, cause);
	}
