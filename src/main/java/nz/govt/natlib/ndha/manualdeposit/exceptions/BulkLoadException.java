...
public class BulkLoadException extends Exception {
	...
	public BulkLoadException(final String message) {
		super(message);
	}

	public BulkLoadException(final Throwable cause) {
		super(cause);
	}

	public BulkLoadException(final String message, final Throwable cause) {
		super(message, cause);
	}
